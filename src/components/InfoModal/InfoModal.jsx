  ...
  return (
    <>
      ...
      <div className="info-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p>
          The Pomodoro technique is a simple time-management method designed to
          help you stay focused and avoid burnout.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>writing</li>
          <li>creative work</li>
          <li>any task requiring sustained attention</li>
        </ul>
        <p>
